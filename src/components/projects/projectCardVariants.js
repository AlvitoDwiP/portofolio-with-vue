...
const VARIANTS = {
  data: {
    ...
    iconShell:
      'border-violet-200/20 bg-violet-400/10 text-violet-100 shadow-[0_18px_40px_rgba(109,40,217,0.28)]',
    metaClass: 'text-violet-200/80',
    techClass: 'border-violet-300/10 bg-violet-400/10 text-violet-100/90',
    linkPrimaryClass:
      'border-violet-300/20 bg-violet-400/10 text-violet-50 hover:border-violet-200/30 hover:bg-violet-400/20',
  ...
  web: {
    ...
    iconShell:
      'border-sky-200/20 bg-sky-400/10 text-sky-100 shadow-[0_18px_40px_rgba(14,165,233,0.24)]',
    metaClass: 'text-sky-200/80',
    techClass: 'border-sky-300/10 bg-sky-400/10 text-sky-100/90',
    linkPrimaryClass:
      'border-sky-300/20 bg-sky-400/10 text-sky-50 hover:border-sky-200/30 hover:bg-sky-400/20',
    dotClass: 'bg-sky-300',
  },
}
