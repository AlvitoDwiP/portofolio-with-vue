...
export const experiences = [
  {
    ...
    certificate: {
      label: 'Sertifikat MAGENTA',
      url: 'https://drive.google.com/file/d/1q62zleu4_IHIvlEUJyr9v7nf5SBlVrG0/view',
    },
    detail: {
      overview:
  ...
  },
  {
    ...
    tools: [],
    certificate: {
      label: 'Sertifikat Studi Independen',
      url: 'https://www.linkedin.com/in/alvito-dwinova-permana-90a7b82ab/overlay/Position/2325951044/treasury/?profileId=ACoAAEqw-hoBpjb7XA9CfY5bxB8UNItRwmFw6Rw',
    },
    detail: {
      overview:
